  ...
  return (
    <footer className="page-footer font-weight-bold pb-lg-0 black">
        ...
        <div className="row">
          <div className="col-md-12 pt-5 pb-5">
            <div>
              ...
              <a className="li-ic" target="_blank" title="Linkedin Profile" href="https://www.linkedin.com/in/mohammad-zunaid/"  rel="noreferrer">
              ...
              <a className="github-ic" target="_blank" title="GitHub profile" href="https://github.com/mohammadzunaid"  rel="noreferrer">
      ...
      <div className="footer-copyright text-center my-0 pb-4 font-small">
        ...
        Designed by
        <span className="gold" onClick={() => scrollToTop()} style={{cursor: 'pointer'}}> Mohammad Zunaid</span>
      </div>
    </footer>
  );
}
