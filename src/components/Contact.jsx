              ...
              <div className="col-md-12 text-center">
                <ul className="list-unstyled mb-0">
                  ...
                  <li >
                    ...
                    <p className="mb-0">
                      <a href="mailto:junaidmohammad53@gmail.com" className="text-white email" title="Send e-mail">
                        junaidmohammad53@gmail.com
                      </a>
                    </p>
                  </li>
                </ul>
            ...
            <MDBContainer>
              ...
              <div className="text-right">
                <MDBIcon icon="paper-plane" title="Send" className="send-icon pb-2 text-white"
                  onClick={()=>{
                    alert("Kindly drop an email to junaidmohammad53@gmail.com as this site currently not integrated with any email service.")
                  }}
                />
              </div>
            </MDBContainer>
